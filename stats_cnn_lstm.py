...
a_cnn = pd.read_csv("accuracies_lstm.csv")
...
w_cnn = pd.read_csv("weights_lstm.csv")

w_cnn_nt = np.array(w_cnn[w_cnn['model']=='nt']['weight'])
w_cnn_asd = np.array(w_cnn[w_cnn['model']=='asd']['weight'])
w_cnn_syn = np.array(w_cnn[w_cnn['model']=='syn']['weight'])
w_cnn_hom = np.array(w_cnn[w_cnn['model']=='hom']['weight'])
...
w_cnn_asd2 = np.array(w_cnn[w_cnn['model']=='asd'].groupby(w_cnn['run'])['weight'].mean())
w_cnn_syn2 = np.array(w_cnn[w_cnn['model']=='syn'].groupby(w_cnn['run'])['weight'].mean())
w_cnn_hom2 = np.array(w_cnn[w_cnn['model']=='hom'].groupby(w_cnn['run'])['weight'].mean())
